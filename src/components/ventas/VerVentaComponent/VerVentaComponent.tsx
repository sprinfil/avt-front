...
export const VerVentaComponent = () => {
  return (
    <>
      <Card>
        <CardContent>
          <Tabs defaultValue="contrato" className="h-[350px] overflow-auto">
            <TabsList>
            ...
            <TabsContent value="contrato">
              <div className="flex-col gap-3 grid grid-cols-1 md:grid-cols-2 ">
                ...
                <div>
                  ...
                  <p className="text-gray-500 hover:underline cursor-pointer flex gap-1 items-center">
                    Marco Antonio Gonzalez {icons.link("w-4 h-4")}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <Button>Subir contrato {icons.agregar()}</Button>
                </div>
              </div>
            </TabsContent>
              ...
              <SharedDataTable
                data={[
                  ...
                  },
                  {
                    consecutivo: "2",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/02/2025",
                    estado: "pagada",
                  },
                  {
                    consecutivo: "3",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/03/2025",
                    estado: "pagada",
                  },
                  {
                    consecutivo: "4",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/04/2025",
                    estado: "pagada",
                  },
                  {
                    consecutivo: "5",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/05/2025",
                    estado: "pagada",
                  },
                  {
                    consecutivo: "6",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/06/2025",
                    estado: "expirada",
                  },
                  {
                    consecutivo: "7",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/07/2025",
                    estado: "pendiente",
                  },
                  {
                    consecutivo: "8",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/08/2025",
                    estado: "pendiente",
                  },
                  {
                    consecutivo: "9",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/09/2025",
                    estado: "pendiente",
                  },
                  {
                    consecutivo: "10",
                    monto: "$ 2,000.00",
                    fecha_expiracion: "15/10/2025",
                    estado: "pendiente",
                  },
                ]}
